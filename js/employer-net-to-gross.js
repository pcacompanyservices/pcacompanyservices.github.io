...
const TEXT_CONFIG = {
  ...
  steps: {
    ...
    allowance: {
      ...
      placeholders: {
        lunch: "Net lunch allowance (VND)",
        fuel: "Net fuel allowance (VND)",
        phone: "Net phone allowance (VND)",
        travel: "Net travel allowance (VND)",
        uniform: "Net uniform allowance (VND)",
        other: "Net other allowance (VND)"
      }
    },
    bonus: {
      title: "Bonus",
      placeholder: "Net total bonus (VND)"
    },
    benefit: {
      title: "Benefit",
      types: {
