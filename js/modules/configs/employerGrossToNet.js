...
export function buildEmployerGrossToNetConfig() {
  ...
  return {
    ...
    steps: [
      ...
      { label: t.progressSteps.grossSalary, render: () => currencyInputStep({ id: 'gross-salary', title: t.steps.grossSalary.title, tooltip: t.infoTooltips.grossSalary, placeholder: t.steps.grossSalary.placeholder, warningId: 'gross-salary-warning', warningText: t.warnings.maxDigits, continueId: 'continue-step2', continueText: t.buttons.continue }) },
