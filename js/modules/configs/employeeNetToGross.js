...
export function buildEmployeeNetToGrossConfig() {
  ...
  return {
    ...
    steps: [
      ...
      {
        label: t.progressSteps.netSalary,
        render: () => currencyInputStep({
          id: 'net-salary',
          title: t.steps.netSalary.title,
          tooltip: t.steps.netSalary.tooltip,
          placeholder: t.steps.netSalary.placeholder,
          warningId: 'net-salary-warning',
          warningText: t.steps.netSalary.warningMaxDigits,
          continueId: 'continue-step2',
          continueText: t.steps.netSalary.continue
        })
      },
      {
