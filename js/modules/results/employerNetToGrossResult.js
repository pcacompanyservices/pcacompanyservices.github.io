...
import { renderCostBreakdownChart } from '../../common/charts.js';
import { exportResultToPdf, ensureJsPdfAndHtml2Canvas } from '../../common/pdf.js';

export function renderEmployerNetToGrossResult(root, data) {
  ...
  resultDiv.innerHTML = `
    ...
    <div class="result-table-container">
      <table class="result-table result-table-vertical result-table-bordered employee-table-layout">
        ...
        <tr><td colspan="2"><div class="result-title">${t.results.sections.employeeTakeHome}</div><div class="result-center-value" style="color:#1a7f3c;">${(data.netSalary||0).toLocaleString('vi-VN')} VND</div></td></tr>
      </table>
    </div>`;
  ...
  pieChartContainer.innerHTML = `
    <div id="cost-chart-block">
      ...
      <div id="cost-breakdown-chart-label" style="display: none;">${t.results.employerCostTable.sections.statutoryContribution}</div>
    </div>`;
