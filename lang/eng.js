...
export const TEXT = {
  ...
  taxResidentStatus: { title: 'Tax Resident Status', selectPlaceholder: "Select your Employee's Tax Resident status", options: { local: 'Local – Tax Resident', expat: 'Expat – Tax Resident' } },
      ...
      benefit: { title: 'Benefit', types: { childTuition: "Child's Tuition Fee", rental: 'Rental', healthInsurance: 'Health Insurance' }, placeholders: { childTuition: "Child's tuition fee (VND)", rental: 'Rental benefit (VND)', healthInsurance: 'Health insurance benefit (VND)' } }
    },
  ...
  healthInsurance: "Specify your Employee's monthly health insurance benefit in the contract."
    },
  ...
  employeeGrossToNet: {
    ...
    progressSteps: { citizenship: 'Status', grossSalary: 'Base Salary', allowance: 'Allowance', bonus: 'Bonus', benefit: 'Benefit' },
    steps: {
      citizenship: { title: 'Tax Resident Status', tooltip: TAX_RESIDENT_STATUS_TOOLTIP_HTML_EMPLOYEE, selectPlaceholder: 'Select your Tax Resident status', options: { local: 'Local – Tax Resident', expat: 'Expat – Tax Resident' }, continue: 'Continue' },
  grossSalary: { title: 'Gross Base Salary', tooltip: "Enter the Employee's gross (contract) salary.", placeholder: 'Min 5.000.000 VND', warningMaxDigits: 'Maximum 9 digits allowed.', continue: 'Continue' },
      allowance: { title: 'Allowance', tooltip: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras vitae.', hasAllowanceLabel: 'There are Allowances in the Contract', warningMaxDigits: 'Maximum 9 digits allowed.', types: { lunch: 'Lunch', fuel: 'Fuel', phone: 'Phone', travel: 'Traveling', uniform: 'Uniform', other: 'Other Allowances' }, tooltips: { lunch: 'Specify your monthly allowance for lunch in the contract.', fuel: 'Specify your monthly allowance for fuel in the contract.', phone: 'Specify your monthly allowance for phone in the contract.', travel: 'Specify your monthly allowance for traveling in the contract.', uniform: 'Specify your monthly allowance for uniform in the contract.', other: 'Enter any other allowances in the contract that are not listed above.' }, placeholders: { lunch: 'Lunch allowance (VND)', fuel: 'Fuel allowance (VND)', phone: 'Phone allowance (VND)', travel: 'Travel allowance (VND)', uniform: 'Uniform allowance (VND)', other: 'Other allowances (VND)' }, continue: 'Continue' },
      bonus: { title: 'Bonus', tooltip: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras vitae.', hasBonusLabel: 'There are Bonuses in the Contract', warningMaxDigits: 'Maximum 9 digits allowed.', types: { productivity: 'Productivity', incentive: 'Incentive', kpi: 'KPI', other: 'Other Bonuses' }, tooltips: { productivity: 'Specify your monthly bonus for productivity in the contract.', incentive: 'Specify your monthly bonus for incentive in the contract.', kpi: 'Specify your monthly bonus for KPI in the contract.', other: 'Enter any other bonuses in the contract that are not listed above.' }, placeholders: { productivity: 'Productivity bonus (VND)', incentive: 'Incentive bonus (VND)', kpi: 'KPI bonus (VND)', other: 'Other bonuses (VND)' } },
      benefit: { title: 'Benefit', warningMaxDigits: 'Maximum 9 digits allowed.', types: { childTuition: "Child's Tuition Fee", rental: 'Rental', healthInsurance: 'Health Insurance' }, placeholders: { childTuition: "Child's tuition fee (VND)", rental: 'Rental benefit (VND)', healthInsurance: 'Health insurance benefit (VND)' }, tooltips: { childTuition: "Specify your monthly child's tuition fee benefit in the contract.", rental: 'Specify your monthly rental benefit in the contract.', healthInsurance: 'Specify your monthly health insurance benefit in the contract.' } }
    },
  ...
  employeeNetToGross: {
    ...
    progressSteps: { citizenship: 'Status', netSalary: 'Base Salary', allowance: 'Allowance', bonus: 'Bonus', benefit: 'Benefit' },
    steps: {
      citizenship: { title: 'Tax Resident Status', tooltip: TAX_RESIDENT_STATUS_TOOLTIP_HTML_EMPLOYEE, selectPlaceholder: 'Select your Tax Resident status', options: { local: 'Local – Tax Resident', expat: 'Expat – Tax Resident' }, continue: 'Continue' },
  netSalary: { title: 'Net Base Salary', tooltip: "Enter the Employee's net (take-home) salary.", placeholder: 'Min 4,475,000 VND', warningMaxDigits: 'Maximum 9 digits allowed.', continue: 'Continue' },
      allowance: { title: 'Allowance', tooltip: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras vitae.', hasAllowanceLabel: 'There are Allowances in the Contract', warningMaxDigits: 'Maximum 9 digits allowed.', types: { lunch: 'Lunch', fuel: 'Fuel', phone: 'Phone', travel: 'Traveling', uniform: 'Uniform', other: 'Other Allowances' }, tooltips: { lunch: 'Specify your monthly allowance for lunch in the contract.', fuel: 'Specify your monthly allowance for fuel in the contract.', phone: 'Specify your monthly allowance for phone in the contract.', travel: 'Specify your monthly allowance for traveling in the contract.', uniform: 'Specify your monthly allowance for uniform in the contract.', other: 'Enter any other allowances in the contract that are not listed above.' }, placeholders: { lunch: 'Lunch allowance (VND)', fuel: 'Fuel allowance (VND)', phone: 'Phone allowance (VND)', travel: 'Travel allowance (VND)', uniform: 'Uniform allowance (VND)', other: 'Other allowances (VND)' } },
      bonus: { title: 'Bonus', tooltip: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras vitae.', hasBonusLabel: 'There are Bonuses in the Contract', warningMaxDigits: 'Maximum 9 digits allowed.', types: { productivity: 'Productivity', incentive: 'Incentive', kpi: 'KPI', other: 'Other Bonuses' }, tooltips: { productivity: 'Specify your monthly bonus for productivity in the contract.', incentive: 'Specify your monthly bonus for incentive in the contract.', kpi: 'Specify your monthly bonus for KPI in the contract.', other: 'Enter any other bonuses in the contract that are not listed above.' }, placeholders: { productivity: 'Productivity bonus (VND)', incentive: 'Incentive bonus (VND)', kpi: 'KPI bonus (VND)', other: 'Other bonuses (VND)' } },
      benefit: { title: 'Benefit', tooltip: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras vitae.', warningMaxDigits: 'Maximum 9 digits allowed.', types: { childTuition: "Child's Tuition Fee", rental: 'Rental', healthInsurance: 'Health Insurance' }, placeholders: { childTuition: "Child's tuition fee (VND)", rental: 'Rental benefit (VND)', healthInsurance: 'Health insurance benefit (VND)' } }
    },
