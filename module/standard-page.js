// Standard page initializer: builds form, handles calculation, renders results, PDF export & footer
// Usage in template:
// import { createSalarySimulationPage } from '../module/standard-page.js';
// document.addEventListener('DOMContentLoaded', () => createSalarySimulationPage({
//   rootId: 'gross-to-net-root', textConfig: TEXT.employeeGrossToNet, direction:'gross-to-net', mode:'employee'
// }));
...
function collectParams({ direction }) {
  ...
  // net-to-gross: treat allowance inputs as net amounts
  return {
    method: 'net-to-gross',
    taxResidentStatus,
